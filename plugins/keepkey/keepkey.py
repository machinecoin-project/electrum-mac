...
from electrum_mac.util import bfh, bh2u, UserCancelled
...
from electrum_mac.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class KeepKeyPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if constants.net.TESTNET else "Machinecoin"
