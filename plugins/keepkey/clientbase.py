...
from electrum_mac.util import PrintError, UserCancelled
from electrum_mac.keystore import bip39_normalize_passphrase
from electrum_mac.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the machinecoins in the wallet.").format(self.device)
        else:
